export const LiquidGlassDay35 = ({
  ...
  return (
    <>
      ...
      <div
        className={`relative inline-flex w-fit items-center justify-center backdrop-blur-[8px]  ${className}`}
      >
        {/* Text content */}
        {children}
        {/* SVG gradient border */}
        ...
        >
          ...
          <rect
            ...
            width="calc(100% - 2px)"
            height="calc(100% - 2px)"
            rx={radius} // Adjust for border radius (same value in rounded-[25px] above)
            ry={radius} // Adjust for border radius
            fill="none"
